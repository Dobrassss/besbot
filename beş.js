...
client.true = function (message) {
  if (message) { message.react(client.emoji("emote_true").id !== null ? client.emoji("emote_true").id : "✅") }
};

client.false = function (message) {
  if (message) { message.react(client.emoji("emote_false").id !== null ? client.emoji("emote_false").id : "❌") }
};
...
client.ceza = async function (id, message, type, reason, durations, süre) {
  ...
  if (!member) return message.react(client.emoji("emote_false").id !== null ? client.emoji("emote_false") .id: "❌");
  message.react(client.emoji("emote_true").id !== null ? client.emoji("emote_true").id : "✅")
...
client.sayıEmoji = (sayi) => {
  ...
  if (bes2) {
    bes = bes.replace(/([0-9])/g, d => {
      return {
        '0': client.emoji("emote_zero").id !== null ? client.emoji("emote_zero").id : "0",
        '1': client.emoji("emote_one").id !== null ? client.emoji("emote_one").id : "1",
        '2': client.emoji("emote_two").id !== null ? client.emoji("emote_two").id : "2",
        '3': client.emoji("emote_three").id !== null ? client.emoji("emote_three").id : "3",
        '4': client.emoji("emote_four").id !== null ? client.emoji("emote_four").id : "4",
        '5': client.emoji("emote_five").id !== null ? client.emoji("emote_five").id : "5",
        '6': client.emoji("emote_six").id !== null ? client.emoji("emote_six").id : "6",
        '7': client.emoji("emote_seven").id !== null ? client.emoji("emote_seven").id : "7",
        '8': client.emoji("emote_eight").id !== null ? client.emoji("emote_eight").id : "8",
        '9': client.emoji("emote_nine").id !== null ? client.emoji("emote_nine").id : "9"
      }[d];
    });
  }
  return bes;
  ...
  taskData.forEach(async (x) => {
    ...
    if (x.completedCount >= x.count) {
      ...
      **${this.toString()} Tebrikler! ${type.charAt(0).toLocaleUpperCase() + type.slice(1)} Görevini Başarıyla Tamamladın!**
      ...
      ${x.message}
      **${client.emoji("emote_coin").id} \`${x.prizeCount} Puan Hesabına Eklendi!\`**
      `);
...
client.progressBar = (value, maxValue, size) => {
  ...
  const progressText = `${client.emoji("emote_fill").id}`.repeat(progress);
  const emptyProgressText = `${client.emoji("emote_empty").id}`.repeat(emptyProgress);

  return emptyProgress > 0
    ? progress === 0
      ? `${client.emoji("emote_emptystart").id}` + progressText + emptyProgressText + `${client.emoji("emote_emptyend").id}`
      : `${client.emoji("emote_fillstart").id}` + progressText + emptyProgressText + `${client.emoji("emote_emptyend").id}`
    : `${client.emoji("emote_fillstart")}.id` + progressText + emptyProgressText + `${client.emoji("emote_fillend").id}`;
};
