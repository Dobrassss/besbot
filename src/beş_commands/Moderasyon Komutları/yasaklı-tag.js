...
module.exports = {
    ...
    execute: async (client, message, args, beş_embed) => {
        ...
        message.reply({ embeds: [beş_embed.setDescription(`> **${client.emoji("emote_true").id !== null ? client.emoji("emote_true").id : "✅"} Belirtilen ${tag} Tagı Yasaklı Taglardan Çıkartıldı!**`)]})
        }else{
        db.push(`bannedtags`,tag)
        message.reply({ embeds: [beş_embed.setDescription(`> **${client.emoji("emote_true").id !== null ? client.emoji("emote_true").id : "✅"} Belirtilen ${tag} Tagı Yasaklı Taglara Eklendi!**`)]})
        }
