...
module.exports = {
    name: "cmute",
    usage:"cmute [Official Development / ID] <süre[10m]> <sebep>",
    category:"moderasyon",
    ...
    execute: async (client, message, args, beş_embed) => {
        ...
        .addComponents(
         ...
         .setEmoji(`${client.emoji("emote_cmute").id !== null ? client.emoji("emote_cmute").id : "🔕"}`)
         ...
         .setStyle(ButtonStyle.Secondary)
         .setEmoji(`${client.emoji("emote_vmute").id !== null ? client.emoji("emote_vmute").id : "🔇"}`)
         .setCustomId("punish_vmute"),
         new ButtonBuilder()
         .setLabel("İptal")
         .setStyle(ButtonStyle.Danger)
         .setEmoji(`${client.emoji("emote_false").id !== null ? client.emoji("emote_false").id : "❌"}`)
         .setCustomId("punish_iptal")
        )


        let mesaj = await message.reply({ components:[buttons],embeds: [beş_embed.setDescription(`> **${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "❓"} Aşağıdaki Butonlardan Bir İşlem Tipi Belirleyiniz!**`)]})
        ...
        beş.reply({content:`> **${client.emoji("emote_true").id !== null ? client.emoji("emote_true").id : "✅"} İşlem Başarıyla İptal Edildi!**`,ephemeral:true})
