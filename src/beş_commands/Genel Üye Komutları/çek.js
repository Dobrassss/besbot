...
module.exports = {
    name: "çek",
    usage: "çek [Official Development / ID]",
    category:"genel",
        ...
        const beş_dropdown = new ActionRowBuilder()
            .addComponents(
                new StringSelectMenuBuilder()
                    ...
                    .addOptions([
                        { label: `Onayla`, description: `Taşıma İşlemini Onayla`, value: `onay`, emoji: `${client.emoji("emote_true").id !== null ? client.emoji("emote_true").id : "✅"}` },
                        { label: `Reddet`, description: `Taşıma İşlemini Reddet`, value: `red`, emoji: `${client.emoji("emote_false").id !== null ? client.emoji("emote_false").id : "❌"}` }]))
        let mesajbeş;
