...
module.exports = {
    ...
    execute: async (client, message, args, beş_embed) => {
        ...
        let menu = new ActionRowBuilder().addComponents(
            ...
            .setOptions([
            {value:`genelkomutlar`,description:`Genel Komutları Gösterir`,label:`Genel Komutlar`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            {value:`statkomutlar`,description:`Stat Komutlarını Gösterir`,label:`Stat Komutları`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            {value:`kayıtkomutlar`,description:`Kayıt Komutlarını Gösterir`,label:`Kayıt Komutları`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            {value:`moderasyonkomutlar`,description:`Moderasyon Komutlarını Gösterir`,label:`Moderasyon Komutları`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            {value:`rolkomutlar`,description:`Rol Komutlarını Gösterir`,label:`Rol Komutlarını`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            {value:`sahipkomutlar`,description:`Sahip Komutlarını Gösterir`,label:`Sahip Komutları`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            {value:`üstytkomutlar`,description:`Üst Yetkili Komutlarını Gösterir`,label:`Üst Yetkili Komutlarını`,emoji:`${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id : "⚕️"}`},
            ])
            .setCustomId("yardım")
