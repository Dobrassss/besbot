...
client.on(Events.InteractionCreate,async(beş) => {
    if(!beş.isStringSelectMenu())return;
     ...
     if(value == "buttonpanel"){
        beş.message.delete();
        beş.channel.send({"content": `> ${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id:"🔹"} Aşağıdaki Menü Üzerinden Sunucu Hakkında\n> Veya Hesabınızla İlgili Bazı Bilgilere Ulaşabilirsiniz.`,
        "components": [{
            "type": 1, "components": [{
        ...
        beş.channel.send({content: `> ${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id:"🔹"} Aşağıdaki Menü Üzerinden **İstek,Öneri,Şikeyat** Veya **Yetkili Başvurusu** Yapabilirsiniz.`,components:[buttons]})
 ...
 if(!beş.isButton())return;
  ...
  if(value == "burcrolkur"){
    ...
    for (let index = 0; index < burc.length; index++) {
        ...
        beş.message.delete();
        beş.channel.send({"content": `> ${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id:"🔹"} Menü Üzerinden **Burç** Rolünüzü Alabilirsiniz.`,
        "components": [{
            "type": 1, "components": [{
    ...
    beş.message.delete();
    beş.channel.send({"content": `> ${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id:"💖"} Menü Üzerinden **İlişki** Rolünüzü Alabilirsiniz.`,
    "components": [{
        "type": 1, "components": [{
    ...
    beş.message.delete();
    beş.channel.send({"content": `> ${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id:"🎉"} Menü Üzerinden **Etkinlik** Rolünüzü Alabilirsiniz.`,
    "components": [{
        "type": 1, "components": [{
    ...
    beş.message.delete();
    beş.channel.send({"content": `> ${client.emoji("emote_value").id !== null ? client.emoji("emote_value").id:"🔹"} Menü Üzerinden **Renk** Rolünüzü Alabilirsiniz.`,
    "components": [{
        "type": 1, "components": [{
