...
module.exports = {
    name: "bonus",
    usage: "bonus [+/-] [Official Development / ID] <Adet>",
    category: "stat",
    ...
    message.reply({ embeds: [beş_embed.setDescription(`> **Örnek Kullanım; \`${beş_config.prefix}bonus [+ / -] [Official Development / ID] [5]\`**`)] })
}
