...
module.exports = {
    name: "invite",
    usage: "invite [Official Development / ID]",
    category: "stat",
    ...
    execute: async (client, message, args, beş_embed) => {
      ...
      .addFields(
      { name: `${client.emoji("emote_invite").id !== null ? client.emoji("emote_invite").id:"📩"} • **Toplam Davet**`,  value: codeBlock("js",`Gerçek: ${davet ? davet.Regular : 0}, Sahte: ${davet ? davet.Fake :0}, Ayrılan: ${davet ? davet.Left : 0}, Bonus: ${davet ? davet.Bonus : 0}`)}
      )
