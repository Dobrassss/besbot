            ...
            .addComponents(
                new StringSelectMenuBuilder()
                    ...
                    .addOptions([
                        ...
                        { label: `Günlük Ses Verileri`, description: `Günlük Verileri Görmek İçin Tıkla!`, value: `gunses`, emoji: `${client.emoji("emote_voice").id !== null ? client.emoji("emote_voice").id : "1105494402136285376"}` },
                        { label: `Günlük Mesaj Verileri`, description: `Günlük Verileri Görmek İçin Tıkla!`, value: `gunchat`, emoji: `${client.emoji("emote_chat").id !== null ? client.emoji("emote_chat").id : "1105494402136285376"}` },
                        { label: `Haftalık Ses Verileri`, description: `Haftalık Verileri Görmek İçin Tıkla!`, value: `haftases`, emoji: `${client.emoji("emote_voice").id !== null ? client.emoji("emote_voice").id : "1105494402136285376"}` },
                        { label: `Haftalık Mesaj Verileri`, description: `Haftalık Verileri Görmek İçin Tıkla!`, value: `haftachat`, emoji: `${client.emoji("emote_chat").id !== null ? client.emoji("emote_chat").id : "1105494402136285376"}` },
                        { label: `Toplam Ses Verileri`, description: `Toplam Verileri Görmek İçin Tıkla!`, value: `toplamses`, emoji: `${client.emoji("emote_voice").id !== null ? client.emoji("emote_voice").id : "1105494402136285376"}` },
                        { label: `Toplam Mesaj Verileri`, description: `Toplam Mesaj Verileri Görmek İçin Tıkla!`, value: `toplamchat`, emoji: `${client.emoji("emote_chat").id !== null ? client.emoji("emote_chat").id : "1105494402136285376"}` },
                        { label: `Davet Verileri`, description: `Davet Verilerini Görmek İçin Tıkla!`, value: `davet`, emoji: `${client.emoji("emote_invite").id !== null ? client.emoji("emote_invite").id : "1103848392460861501"}` },
                        ...
                        { label: `Ses Kanalların Verileri`, description: `Ses Kanalların Verilerini Görmek İçin Tıkla!`, value: `seskanal`, emoji: `${client.emoji("emote_voice") !== null ? client.emoji("emote_voice").id : "1103848389000560760"}` },
                        { label: `Mesaj Kanalların Verileri`, description: `Mesaj Kanalların Verilerini Görmek İçin Tıkla!`, value: `mesajkanal`, emoji: `${client.emoji("emote_chat").id !== null ? client.emoji("emote_chat").id : "1103848389000560760"}` }]))

        mesaj.edit({ content: ``, components: [beş_dropdown], embeds: [beş_embed.setDescription(`> **${client.emoji("emote_hi").id !== null ? client.emoji("emote_hi").id : ""} Aşşağıdaki Menü Üzerinden Sıralama Verilerini Görebilirsiniz!**\n\n> ${client.emoji("emote_warn").id !== null ? client.emoji("emote_warn").id : "❓"} *Veya \`.top mesaj,ses,davet,yayın,kamera\` vb. Şekilde Belirtebilirsiniz!*`).setThumbnail(message.author.displayAvatarURL({ dynamic: true, size: 2048 }))] })
