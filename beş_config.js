module.exports = {
    ...
    token: "MTIwNjY4MTAwNjc0NTMyMTUxMg.G8c3ED.zAoA5e77bY3K1A68HO1H3y1J25wK0zY578jAYo", //Bot Tokeniniz => Bot Oluşturduktan Sonra Intentsleri Açmayı Unutma!
    guildID: "1101236729391886356", //Kullanıcağın Sunucunun ID'si
    voiceChannelID: "1206680963233619988", // Ses Kanal ID'si
    presence: "Offical Team Was Here !", //Botun Durumu
    footer: "Official & Official Development", //Embedların Footer Yazısı
    ...
    staffs: ["1206682771175505940"], // Yetkililerin Rol ID'leri ["55555","55555"] Şeklinde Girilir
